...
START_DATE = "2013-01-01" # Start time to aggregate points
END_DATE = "2015-01-01" # End time to aggregate points
INPUT_DATE_FIELD = "date" # Data dependent field representing the date associated to a point
